...
%sel = sel(1:100);
X=[X_zset ; X_zrollset(1:600,:) ; X_pitchset ; X_rollset];
y=[y_zset ; y_zrollset(1:600,:) ; y_pitchset ; y_rollset];
Xcv=X_zrollset(601:800,:);
ycv=y_zrollset(601:800,:);
Xtest=X_zrollset(801:end,:);
ytest=y_zrollset(801:end,:);
for i=1:6
    y(:,13)=[];
    X(:,17)=[];
end;
...
[nn_params]= gradientDescentMulti(X,y,nn_params,alpha,num_iters,...
